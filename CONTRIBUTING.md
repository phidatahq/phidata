...
3. Create a Class for your VectorDb that implements the `VectorDb` interface
   ...
   - Checkout the [`agno/cookbook/agent_concepts/knowledge/vector_dbs`](https://github.com/agno-agi/agno/blob/main/cookbook/agent_concepts/knowledge/vector_dbs/pg_vector.py) file for an example.
