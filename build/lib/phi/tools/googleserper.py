...
class SerperTool(Toolkit):
    def __init__(
        ...
        self.headers: Optional[Any] = {"X-API-KEY": self.api_key, "Content-Type": "application/json"}
    ...
    def serper_search(self, query: str, num: int = 5, country: str = "us") -> str:
        ...
        payload = json.dumps({"q": query, "num": self.fixed_max_results or num, "gl": country})
...
if __name__ == "__main__":
    ...
    os.environ["SERPER_API_KEY"] = "d8b60401260c0238aadb5a92c23334428bc71b59"
    serper_tool = SerperTool()
    print(serper_tool.serper_search("Tarun Jain"))
