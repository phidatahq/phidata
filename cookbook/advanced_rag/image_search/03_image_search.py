...
assistant = Assistant(
    ...
    tools=[search],
    instructions=["Query the Pinecone index for images related to the given text. Which image best matches what the user is looking for? Provide the filename and score."],
