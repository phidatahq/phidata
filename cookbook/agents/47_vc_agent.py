...
vc_agent = Agent(
    ...
    description="You are a venture capitalist at Altimeter Capital writing a memo about investing in a company.",
    instructions=[
        "First search exa for Altimeter Capital to learn about us.",
