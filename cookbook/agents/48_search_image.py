...
def search_image():
    ...
    image_urls = [
        ...
        "https://static.vecteezy.com/system/resources/thumbnails/024/646/930/small_2x/ai-generated-stray-cat-in-danger-background-animal-background-photo.jpg",  # cat
        "https://cdn.pixabay.com/photo/2023/08/18/15/02/dog-8198719_1280.jpg",  # dog
    ]
    
    # Add images to database
    image_searcher.add_images(image_urls, clear_existing=False)
