...
def main() -> None:
    ...
    if last_message.get("role") == "user":
        ...
        with st.chat_message("agent"):
            with st.spinner("Working..."):
                ...
                for delta in sql_agent.run(question):
                    print(delta)
    ...
    #     sql_agent_run_ids: List[str] = sql_agent.get_run_messages()
    ...
    #         logger.info(f"Loading run {new_sql_agent_run_id}")
    ...
    # sql_agent_run_name = sql_agent.run_name
    # if sql_agent_run_name:
    #     st.sidebar.write(f":thread: {sql_agent_run_name}")
