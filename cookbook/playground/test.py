...
image_agent = Agent(
    ...
    storage=PostgresAgentStorage(table_name="image_agent", db_url=db_url),
)
...
ml_gif_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="ml_gif_agent", db_url=db_url),
)
...
ml_video_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="ml_video_agent", db_url=db_url),
)
...
fal_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="fal_agent", db_url=db_url),
)
...
gif_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="gif_agent", db_url=db_url),
)
...
audio_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="audio_agent", db_url=db_url),
)
...
image_to_image_agent = Agent(
    ...
    storage=PostgresAgentStorage(table_name="image_to_image_agent", db_url=db_url),
)
...
hindi_audio_agent = Agent(
    ...
    add_history_to_messages=True,
    add_datetime_to_instructions=True,
    storage=PostgresAgentStorage(table_name="hindi_audio_agent", db_url=db_url),
)
