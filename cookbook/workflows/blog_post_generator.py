...
class BlogPostGenerator(Workflow):
    ...
    def generate_blog_post(self, topic: str) -> RunResponse:
        print("generate_blog_post")
        print(topic)
        return RunResponse(content="Generated blog post", event=RunEvent.workflow_completed)

    @Workflow.register(description="Delete the blog post for a given topic")
    def delete_blog_post(self, topic: str) -> RunResponse:
        print("delete_blog_post")
        print(topic)
        return RunResponse(content="Deleted blog post", event=RunEvent.workflow_completed)

    @Workflow.register(description="Update the blog post for a given topic")
    def update_blog_post(self, topic: str, blog_post: str) -> RunResponse:
        print("update_blog_post")
        print(topic)
        print(blog_post)
        return RunResponse(content="Updated blog post", event=RunEvent.workflow_completed)
...
if __name__ == "__main__":
    ...
    # blog_post: Iterator[RunResponse] = generate_blog_post.update_blog_post(topic=topic, use_cache=True)
    ...
    agent.run("update the blog post for the topic 'Why Cats Secretly Run the Internet'")
