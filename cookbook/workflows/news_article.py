...
class GenerateNewsReport(Workflow):
    ...
    def get_report_from_cache(self, use_cached_report: bool, topic: str) -> Optional[RunResponse]:
    ...
    def run(
        ...
        cached_report: Optional[RunResponse] = self.get_report_from_cache(use_cached_report, topic)
