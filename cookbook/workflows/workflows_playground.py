...
2. Run the script using: `python cookbook/workflows/playground.py`
"""
...
app = Playground(workflows=[blog_post_generator, news_report_generator, investment_report_generator, startup_idea_validator]).get_app()
