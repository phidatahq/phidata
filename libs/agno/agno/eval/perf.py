...
class PerfResult:
    ...
    def pretty_print(self, console: Console):
        # Create performance table
        perf_table = Table(title="Performance Results", show_header=True, header_style="bold magenta")
...
class FunctionEval:
    ...
    def run(self) -> PerfResult:
        ...
        # Show pretty printed results if enabled
        if self.show_results:
            self.result.pretty_print(console)
