...
def get_openai_key_sidebar() -> Optional[str]:
    """Sidebar component to get OpenAIChat API key"""

    # Get OpenAIChat API key from environment variable
    ...
    if openai_key is None or openai_key == "" or openai_key == "sk-***":
        api_key = st.sidebar.text_input("OpenAIChat API key", placeholder="sk-***", key="api_key")
