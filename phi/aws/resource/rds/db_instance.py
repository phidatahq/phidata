...
class DbInstance(AwsResource):
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.enable_iamdatabase_authentication:
            not_null_args["EnableIAMDatabaseAuthentication"] = self.enable_iamdatabase_authentication
        ...
        if self.performance_insights_kmskey_id:
            not_null_args["PerformanceInsightsKMSKeyId"] = self.performance_insights_kmskey_id
    ...
    def _read(self, aws_client: AwsApiClient) -> Optional[Any]:
        ...
        try:
            ...
            describe_response = service_client.describe_db_instances(DBInstanceIdentifier=db_instance_identifier)
