...
class SupersetBase(K8sApp):
    ...
    def get_db_schema(self) -> Optional[str]:
        return self.db_schema or self.get_secret_from_file("DATABASE_DB")

    def get_db_dialect(self) -> Optional[str]:
        return self.db_dialect or self.get_secret_from_file("DATABASE_DIALECT")
    ...
    def get_container_env(self, container_context: ContainerContext) -> Dict[str, str]:
        ...
        if self.db_app is not None and isinstance(self.db_app, DbApp):
            ...
            if db_dialect is None:
                db_dialect = self.db_app.get_db_driver()
