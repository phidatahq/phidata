    ...
    def __init__(self, **data):
        ...
        if self.__class__.run is not Workflow.run:
            ...
            self._run_parameters = {
                name: {
                    "name": name,
                    "default": param.default.default if hasattr(param.default, "__class__") and param.default.__class__.__name__ == "FieldInfo" else (param.default if param.default is not inspect.Parameter.empty else None),
                    "annotation": (
