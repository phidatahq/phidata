...
class NodeExporterArgs(PhidataAppArgs):
    name: str = "node-exporter"
    version: str = "1"
    enabled: bool = True

    # -*- Image Configuration
    image_name: str = "prom/node-exporter"
...
class NodeExporter(PhidataApp):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        try:
            self.args: NodeExporterArgs = NodeExporterArgs(
                name=name,
                version=version,
                enabled=enabled,
                image=image,
    ...
    def get_k8s_rg(self, k8s_build_context: Any) -> Optional[Any]:
        ...
        nodeexporter_container = CreateContainer(
        ...
        nodeexporter_deployment = CreateDeployment(
