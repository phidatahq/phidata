...
from phidata.k8s.resource.apps.v1.deployment_strategy import DeploymentStrategy
from phidata.k8s.resource.core.v1.pod_template_spec import PodTemplateSpec
from phidata.k8s.resource.meta.v1.label_selector import LabelSelector
