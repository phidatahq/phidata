...
class BaseStorageTest(unittest.TestCase, ABC):
    @abstractmethod
    def setUp(self):
        pass

    def test_create_and_read_session(self):
        session = AgentSession(session_id="test_session", agent_id="agent_1", user_id="user_1", agent_data={})
    ...
    def test_get_all_session_ids(self):
        session1 = AgentSession(session_id="session_1", agent_id="agent_1", user_id="user_1", agent_data={})
        session2 = AgentSession(session_id="session_2", agent_id="agent_1", user_id="user_1", agent_data={})
